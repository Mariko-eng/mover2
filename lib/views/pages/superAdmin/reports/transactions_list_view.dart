...
class SuperAdminTransactionsListView extends StatefulWidget {
  final DateTime dateTime;
  final TextEditingController dateInput;
  const SuperAdminTransactionsListView({super.key, required this.dateInput, required this.dateTime});

  @override
  State<SuperAdminTransactionsListView> createState() => _BusCompanyTransactionsListViewState();
}

class _BusCompanyTransactionsListViewState extends State<SuperAdminTransactionsListView> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          FutureBuilder(
              future: TransactionModel.getTransactionsByDate(
