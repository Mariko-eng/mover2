...
class BusAdminReportTripTicketsListView extends StatefulWidget {
  ...
  const BusAdminReportTripTicketsListView({super.key, required this.reportModel, required this.company});

  @override
  State<BusAdminReportTripTicketsListView> createState() => _ReportTripTicketsState();
}

class _ReportTripTicketsState extends State<BusAdminReportTripTicketsListView> {
  @override
